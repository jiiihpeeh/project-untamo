...
fn icon_inner(icon: Icon) -> &'static str {
    match icon {
        ...
        Icon::Tablet => {
            r#"<rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><line x1="12" x2="12.01" y1="18" y2="18"/>"#
        }
        Icon::Cpu => {
            r#"<rect x="4" y="4" width="16" height="16" rx="2"/><rect x="8" y="8" width="8" height="8" rx="1"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="M7 2v2"/><path d="M7 20v2"/><path d="M17 2v2"/><path d="M17 20v2"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="M2 7h2"/><path d="M20 7h2"/><path d="M2 17h2"/><path d="M20 17h2"/>"#
        }
        Icon::LayoutGrid => {
