...
export const numberToWeekDay = (number:number):WeekDay =>{
    switch(number){
        case 1:
...
const initAlarmDate = (timeString:string) => {
...
const insertDate = (dateObj: Date, dateString: string) => {
...
export const nextAlarmOnce = (timeString: string, date: string) => {
...
export const nextAlarmYearly = (timeString: string, date: string) => {
    let timeNow = new Date()
    let timeCompare = initAlarmDate(timeString)
    timeCompare = insertDate(timeCompare, date)
...
export const nextAlarmDaily = (timeString: string) => {
    let timeNow = new Date()
    let timeCompare = initAlarmDate(timeString)
    if (timeCompare < timeNow){
...
export const nextAlarmWeekly = (timeString: string, weekdays: Array<WeekDay>) => {
    let timeNow = new Date()
    let timeCompare = initAlarmDate(timeString)
