...
import { Text, Link, Spacer, HStack, Avatar, Flex, Image, Icon } from './ui'
...
import { FaChevronDown as Down, FaChevronUp as Up } from 'react-icons/fa'
...
function NavGrid() {
    ...
    const [pointing, setPointing] = useState(Down)
