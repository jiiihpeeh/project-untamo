...
import { Input, InputGroup, Box, VisuallyHidden,
         ...
         FormLabel, Text, Button } from '../../components/ui'
import { useServer,  usePopups, useSettings, useLogIn } from '../../stores'
import useRegister from './RegisterBackend'
import { MdCheckCircle as CheckCircleIcon, MdBlock as NotAllowedIcon, MdWarning as WarningTwoIcon } from 'react-icons/md'
